...
export function packEnt(outFile, { name, objects, variables, functions, messages = [], speed = 60, tmpDir, selected }) {
    ...
    const project = {
        ...
        variables, messages, functions: functions.map(({ jsName, order, ...f }) => f), tables: [], speed,
        interface: { canvasWidth: 480, menuWidth: 280, object: selected || outObjects[0].id },
