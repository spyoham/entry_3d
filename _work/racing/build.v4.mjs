...
export const C = {
    ...
    NSEG: 480,          // centreline rings per circuit (ring NSEG+1 == ring 1)
    ...
    NCARV: 56,          // vertices in the car model
    NCARF: 30,          // faces in the car model
    NSCENE: 900,        // scenery instances placed around a circuit
