...
const prog = compileProgram([fs.readFileSync('bench3.src.js', 'utf8')]);
const pics = [];
for (let i = 0; i < 8; i++) {
...
packEnt('bench3.ent', { name: 'bench', tmpDir: './.pk', variables: prog.variables, functions: prog.functions, messages: prog.messages,
