...
const prog = compileProgram([fs.readFileSync('bench2.src.js', 'utf8')]);
const pics = [];
for (let i = 0; i < 8; i++) {
...
packEnt('bench2.ent', { name: 'bench', tmpDir: './.pk', variables: prog.variables, functions: prog.functions, messages: prog.messages,
